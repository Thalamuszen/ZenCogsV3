...
#            return await ctx.send("Maybe you should find some friends.")
        ...
        if item in author_inv:
            ...
            await ctx.send("You don't own this item. Check your inventory below:")
...
#	NEED TO EXTRACT GIFTER FROM GIFT COMMAND AND APPLY IT TO SOMEWHERE BELOW
    ...
    async def _show_store(self, ctx):
        ...
        if sorted_xmas == []:
            ...
            embed_x.description=f"Welcome to Elune's Christmas shop, here you will find gifts to send your friends for the festive period!\n\nAfter your purchase, use the `!gift` command to gift the item to your friends.\nWhen Christmas is upon us, the `!open` command will be available. Keep an eye on the Elune Updates channel.\n\n`!buy <quantity> <item_name>`\n{output}"	
