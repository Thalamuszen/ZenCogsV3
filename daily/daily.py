...
class Daily(commands.Cog):
    ...
    async def quests(self, ctx: commands.Context):
        ...
        if quests_built < midnight_check:
            ...
            fishing_quest_total = int(randint(15, 30))
        ...
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/768197304158257234/789280443802583061/TavernKeeper3-Bright.gif")
        embed.set_author(
